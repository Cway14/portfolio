        ...
        <Layout>
            ...
            <ul className={styles.projectcontainer}>
                ...
                <li>
                    ...
                    <p>Using sci-kit learn&apos;s machine learning models, my teamates and I were able to predict the next-day trend directions with a 84% accuracy using support vector machines. We classified the made our predictions using a Volatility Index, U.S. 10 Treasury Bonds, and the U.S. Dollar Index. To achieve our promising result, we tested several hyperparameter tuning methods including GridSearchCV, RandomSearch, and Optuna.</p>
